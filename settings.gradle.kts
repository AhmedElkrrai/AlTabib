...
include(":featuers:favorites:presentation")
include(":featuers:doctors:presentation")
include(":featuers:appointments:presentation")
include(":featuers:analytics:domain")
include(":featuers:analytics:presentation")
include(":featuers:profile:domain")
include(":featuers:profile:presentation")
include(":featuers:analytics:data")
