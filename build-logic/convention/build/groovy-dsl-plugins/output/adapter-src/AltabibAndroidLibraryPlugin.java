...
/**
 * Precompiled altabib.android.library script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class AltabibAndroidLibraryPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AltabibAndroidLibrary").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AltabibAndroidLibrary").asSubclass(BasicScript.class);
