...
/**
 * Precompiled altabib.kotlin script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class AltabibKotlinPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AltabibKotlin").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("kotlin.core");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AltabibKotlin").asSubclass(BasicScript.class);
