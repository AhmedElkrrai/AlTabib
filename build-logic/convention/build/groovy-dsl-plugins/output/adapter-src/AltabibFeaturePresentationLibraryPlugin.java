...
/**
 * Precompiled altabib.feature.presentation.library script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class AltabibFeaturePresentationLibraryPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AltabibFeaturePresentationLibrary").asSubclass(BasicScript.class);
