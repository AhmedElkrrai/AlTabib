...
/**
 * Precompiled altabib.feature.domain.library script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class AltabibFeatureDomainLibraryPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AltabibFeatureDomainLibrary").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("altabib.kotlin");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AltabibFeatureDomainLibrary").asSubclass(BasicScript.class);
